...
import site_exp from "../../Assets/site explorer.webp";
    ...
    <div className="lg:pt-20">
      ...
      <div className="flex relative -top-28  lg:left-40 max-lg:top-10 left-10 flex-col gap-4">
        ...
        <div className="flex bg-[#bfc7d9] *:font-semibold border w-fit px-2 p-1 rounded-xl gap-1">
          <p>Home</p>
          <p>/</p>
          <p className="text-[#fa702a]">Site Explorer</p>
        </div>
      </div>
      <div className="lg:flex gap-5 lg:pt-20 pt-40 lg:px-[15%] lg:p-10 p-2 items-center">
        <img src={site_exp} alt="" className="lg:h-[26rem]" />
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <p className="h-1 w-11 bg-red-500"></p>
            <p className=" text-[#23306e] font-semibold">SITE EXPLORER</p>
          </div>
          <p className="text-[#343a40] lg:text-4xl font-bold drop-shadow-2xl">
            Site Explorer in <br />
            Noida, India
          ...
          <p>
            Site Explorer Company offering Site Explorer Marketing Services to
            pull up your websites and help you to earn better ROI.
          </p>
          <p>
            Aara Global provides result-orientated pay-per-click campaign (PPC)
            services for both local and global clients. Site Explorer or PPC
          ...
          <p>
            Our Site Explorer build in the development and implementation of
            Site Explorer marketing strategies, keyword search and selection, ad
      ...
      <div className="lg:flex gap-5 bg-[#f7f7f7] lg:px-[15%] lg:p-10 p-2 items-center">
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            consistently good in quality Google Adwords OR Site Explorer
            service, provider. We offering top-grade Site Explorer service for
      ...
      <div className="text-center flex flex-col gap-3 justify-center items-center lg:p-20 p-4">
        ...
        <p className="px-[30%]">
          ...
          grow your business. Site Explorer is a way to buy visits to your site
