...
import keyword_exp from "../../Assets/Content explorer.webp";
    ...
    <div className="lg:pt-20">
      ...
      <div className="flex relative -top-28  lg:left-40 max-lg:top-10 left-10 flex-col gap-4">
        ...
        <div className="flex bg-[#bfc7d9] *:font-semibold border w-fit px-2 p-1 rounded-xl gap-1">
          <p>Home</p>
          <p>/</p>
          <p className="text-[#fa702a]">Content Explorer</p>
        </div>
      </div>
      <div className="lg:flex gap-5 lg:pt-20 pt-40 lg:px-[15%] lg:p-10 p-2 items-center">
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <p className="h-1 w-11 bg-red-500"></p>
            <p className=" text-[#23306e] font-semibold">CONTENT EXPLORER</p>
          </div>
          <p className="text-[#343a40] lg:text-4xl font-bold drop-shadow-2xl">
            Content Explorer in
            <br />
          ...
          <p>
            Content Explorer Company offering Content Explorer Marketing
          ...
          <p>
            ...
            services for both local and global clients. Content Explorer or PPC
          ...
          <p>
            Our Content Explorer build in the development and implementation of
            Content Explorer marketing strategies, keyword search and selection,
      ...
      <div className="lg:flex gap-5 bg-[#f7f7f7] lg:px-[15%] lg:p-10 p-2 items-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-[#343a40] lg:text-xl font-semibold drop-shadow-lg">
            ...
            consistently good in quality Google Adwords OR Content Explorer
            service, provider. We offering top-grade Content Explorer service
      ...
      <div className="text-center flex flex-col gap-3 justify-center items-center lg:p-20 p-4">
        ...
        <p className="px-[30%]">
          ...
          grow your business. Content Explorer is a way to buy visits to your
